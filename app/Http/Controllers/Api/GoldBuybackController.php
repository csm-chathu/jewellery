...
class GoldBuybackController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'proof_images.*.url'    => 'required_with:proof_images|url|max:1000',
            'proof_images.*.public_id' => 'nullable|string|max:255',
            'proof_images.*.width'  => 'nullable|integer|min:1',
            'proof_images.*.height' => 'nullable|integer|min:1',
            'proof_images.*.bytes'  => 'nullable|integer|min:1',
            'proof_images.*.format' => 'nullable|string|max:20',
        ]);
